...
const NavSide = () => {
  ...
  return (
    <nav className='w-72 h-[100vh] p-5 flex flex-col gap-10 justify-between pr-0'>

      <div className='flex flex-col gap-10' style={{width:"inherit"}}>
        ...
        <div className='w-full flex items-start justify-center gap-4 flex-col '>
          ...
          {links.map((items) => (
            ...
            <Link to={items.to}  className='w-full flex items-center gap-3 h-12 hover:opacity-70 relative' key={items.id}> {items.icon} {items.title}
